...
%% Here we are actually calculating the no of firms rated per year as well 
%% as no of firms rated per analyst per year
...
switch choice
    case 2
        ...
        figure(1)
        plot(g./t)
        title(['no of companies rated per analyst for every year by people having between ',mini,' and ',maxi,' reports and exp. between ',exmi,' and ',exma,' years'])
        xlabel('Years from 2000 to 2013')
        ylabel('No of companies rated per analyst')
        
        figure(2)
        plot(g)
        title(['no of companies rated for every year by people having between ',mini,' and ',maxi,' reports and exp. between ',exmi,' and ',exma,' years'])
        xlabel('Years from 2000 to 2013')
    ...
    case 1
        ...
        figure(1)
        plot(v(7:end-5))
        title(['no of companies rated per analyst for every month by people having between ',mini,' and ',maxi,' reports and exp. between ',exmi,' and ',exma,' years'])
        xlabel('Months from JULY 2000 to JULY 2013')
        ylabel('No of companies rated per analyst')
        
        figure(2)
        plot(g(7:end-5))
        title(['no of companies rated for every month by people having between ',mini,' and ',maxi,' reports and exp. between ',exmi,' and ',exma,' years'])
        xlabel('Months from JULY 2000 to JULY 2013')
        ylabel('No of companies rated')
